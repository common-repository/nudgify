 ...
 */
class NudgifySentryClientSniffer implements NudgifySentryClientExtension
{
    /**
    ...
    public function apply($event, $exception, $request)
    {
        ...
        $context = $browser_name === "bot"
            ? new NudgifySentryBrowserContext("{$browser_name}/{$browser_version}", null)
            : new NudgifySentryBrowserContext(
                $browser_name,
